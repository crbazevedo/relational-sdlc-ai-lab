...
negatives lever (R18) & harder, not more (M5 GPU; b192/384 OOM) & \textbf{+0.137} & vs random +0.120 \\
hardness multi-seed (R19) & hardness gain real, not MPS noise & +0.142 & paired gap +0.020 \\
\bottomrule
\end{tabular}
\end{center}
